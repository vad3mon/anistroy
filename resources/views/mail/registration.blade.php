                        ...
                        <tr>
                            <td style="padding: 10px 0 50px 0;">
                                <p style="margin: 0;font-weight: 400;font-size: 16px;line-height: 25px; text-align: center;">
                                    Регистрация на сайте <a style="color: #1061AB; text-decoration: underline; font-weight: 700;" href="https://anistroy.ru" target="_blank">anistroy.ru</a>
                                </p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="padding-top: 20px">
                                            <p style="margin: 0; font-size: 14px;">
                                                Вы зарегистрировались на сайте <a href="https://anistroy.ru">anistroy.ru</a>
                                            </p>
