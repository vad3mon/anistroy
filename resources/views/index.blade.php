            ...
            <div class="products__swiper swiper">
                <ul class="swiper-wrapper">
                    ...
                    @foreach($discountProducts as $product)
                        <li class="card swiper-slide" data-pid="{{ $product->id }}" data-stock="10000000" data-img="https://res.cloudinary.com/lmru/image/upload/dpr_2.0,f_auto,q_auto,w_240,h_240,c_pad,b_white,d_photoiscoming.png/LMCode/82325238.jpg" data-price="{{ $product->price }}" data-title="{{ $product->name }}">
